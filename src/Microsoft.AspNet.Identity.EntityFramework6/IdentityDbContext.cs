...
namespace Microsoft.AspNet.Identity.EntityFramework6
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder builder)
        {
            ...
            builder.Entity<TUser>().Property(u => u.NormalizedUserName).HasColumnAnnotation("Index", new IndexAttribute("UserNameIndex"));
            builder.Entity<TUser>().Property(u => u.NormalizedEmail).HasColumnAnnotation("Index", new IndexAttribute("EmailIndex"));
            ...
            builder.Entity<TRole>().Property(u => u.NormalizedName).HasColumnAnnotation("Index", new IndexAttribute("RoleNameIndex"));
